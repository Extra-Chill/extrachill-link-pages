...
defined( 'EXTRACHILL_LINK_PAGES_VERSION' ) || define( 'EXTRACHILL_LINK_PAGES_VERSION', '0.9.0' );
...
function ec_link_pages_runtime_function_contract() {
	...
	return $contract + array(
		...
		'ec_link_page_meta_value_matches'                => array(
			'required' => 2,
			'total'    => 2,
		),
		...
		'ec_link_page_previous_links_meta_keys'          => array(
			'required' => 0,
			'total'    => 0,
		),
		'ec_link_page_links_count'                       => array(
			'required' => 1,
			'total'    => 1,
		),
		'ec_link_page_restore_point_timestamp'           => array(
			'required' => 0,
			'total'    => 0,
		),
		'ec_refuse_link_page_silent_empty'               => array(
			'required' => 3,
			'total'    => 3,
		),
		'ec_write_link_page_restore_point'               => array(
			'required' => 2,
			'total'    => 2,
		),
		'ec_get_link_page_previous_links'                => array(
			'required' => 1,
			'total'    => 1,
		),
		...
		'ec_link_page_public_host'                       => array(
			'required' => 0,
			'total'    => 0,
		),
		'ec_link_page_public_base_url'                   => array(
			'required' => 0,
			'total'    => 0,
		),
		'ec_link_page_root_slug'                         => array(
			'required' => 0,
			'total'    => 0,
		),
		'ec_get_link_page_edit_endpoints'                => array(
			'required' => 0,
			'total'    => 0,
		),
		'ec_is_link_page_edit_request'                   => array(
			'required' => 0,
			'total'    => 0,
		),
		'ec_get_link_page_editor_configuration_for_user' => array(
			'required' => 1,
			'total'    => 1,
		),
		'ec_register_link_page_editor_configuration_ability' => array(
			'required' => 0,
			'total'    => 0,
		),
		'ec_enqueue_link_page_edit_shell'                => array(
			'required' => 0,
			'total'    => 0,
		),
		'ec_link_page_edit_document_title'               => array(
			'required' => 1,
			'total'    => 1,
		),
		'ec_link_page_edit_robots'                       => array(
			'required' => 1,
			'total'    => 1,
		),
		...
		'ec_exclude_link_page_from_core_sitemap'         => array(
			'required' => 1,
			'total'    => 1,
		),
		...
		'ec_link_page_apply_host_features'               => array(
			'required' => 3,
			'total'    => 3,
		),
		'ec_render_link_page_subscribe_trigger'          => array(
			'required' => 0,
			'total'    => 0,
		),
		'ec_render_link_page_subscribe_component'        => array(
			'required' => 2,
			'total'    => 2,
		),
		'ec_enqueue_link_page_feature_assets'            => array(
			'required' => 1,
			'total'    => 1,
		),
		'ec_link_page_owned_schema_graph'                => array(
			'required' => 2,
			'total'    => 2,
		),
		...
		'ec_social_link_types'                           => array(
			'required' => 0,
			'total'    => 0,
		),
		'ec_sanitize_social_links'                       => array(
			'required' => 1,
			'total'    => 2,
		),
		'ec_social_link_icon_class'                      => array(
			'required' => 1,
			'total'    => 1,
		),
		'ec_social_link_label'                           => array(
			'required' => 1,
			'total'    => 1,
		),
		'ec_render_social_links'                         => array(
			'required' => 1,
			'total'    => 2,
		),
		'ec_render_link_page_social_links'               => array(
			'required' => 1,
			'total'    => 2,
		),
...
$ec_link_pages_edit_entry_result = ec_load_link_pages_runtime_component( $ec_link_pages_edit_entry_contract, EXTRACHILL_LINK_PAGES_PLUGIN_DIR . 'inc/edit-entry.php' );
if ( is_wp_error( $ec_link_pages_edit_entry_result ) ) {
	ec_record_link_pages_runtime_error( $ec_link_pages_edit_entry_result );
}
