...
function ec_prepare_link_pages_activation( $network_wide = false ) {
	...
	return function_exists( 'is_multisite' ) && is_multisite() && $network_wide
		? ec_for_each_link_pages_site( 'ec_flush_link_pages_site' )
		: ec_flush_link_pages_site();
}
...
function ec_deactivate_link_pages( $network_wide = false ) {
	$result = function_exists( 'is_multisite' ) && is_multisite() && $network_wide
		? ec_for_each_link_pages_site( 'ec_unregister_and_flush_link_pages_site' )
