	...
	public function test_homeboy_package_manifest_contains_only_runtime_source_and_readme(): void {
		...
		$this->assertSame(
			array(
				...
				'assets/js/link-page-edit-button.js',
				'assets/js/link-page-edit-shell.js',
				'assets/js/link-page-public-tracking.js',
				'assets/js/link-page-subscribe.js',
				...
				'inc/section-sources.php',
				'inc/social-types.php',
				'inc/storage.php',
				'templates/components/single-link.php',
				'templates/components/subscribe-inline-form.php',
				'templates/components/subscribe-modal.php',
				'templates/edit-shell.php',
